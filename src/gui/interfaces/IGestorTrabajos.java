...
public interface IGestorTrabajos {
    ...
    public static final String TRABAJO_FINALIZAR_ALUMNO_INEXISTENTE = "El trabajo no tiene un alumno para finalizar o el alumno ya finalizo su participacion en el trabajo";
